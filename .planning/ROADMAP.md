...
- [x] 03-02-PLAN.md — Performance profiles + kinematics helpers (PERF-01)
- [x] 03-03-PLAN.md — Flight-phase FSM: 8-state enum + legal transitions (PERF-02)

**Wave 2** *(blocked on Wave 1)*

- [x] 03-04-PLAN.md — Aircraft nm-coordinate evolution + procedure-following + sim_step dispatch (PROC-01)
